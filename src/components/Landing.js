        ...
        <div className="six-sub">
          ...
          <div className="landing-six-img3">
            ...
            <div>
              <h3>Merchants</h3>
              <p>
                We empower 500,000+ merchants with cutting-edge technologies
                that help them multiply reach and sales.{" "}
              </p>
              <a href="./merchant">
        ...
        <section className="landing-seven">
          ...
          <div ref={slider}>
            <div className="free-counselling" ref={ref1}>
              <h3>Free counselling</h3>
              <p>
                We talk about mental health. This one's for you <br></br> and
                your family.
              </p>
