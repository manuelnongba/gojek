  ...
  return (
    ...
    >
      <div>
          ...
          <div className="product-goride">
            ...
            <div>
              <h3 className="quote">
                ...
                family. I think Gojek is a company that can help a lot of
                people."
              </h3>
        ...
        <section className="product product-three driver-four">
          <div className="three-heading">
            <h2>Come, be a Gojek driver partner?</h2>
          </div>

          <div className="driver-goride">
            <div>
              <img
                alt="Gojek Goride"
                src="https://lelogama.go-jek.com/prime/upload/image/goride-horizontal-logo-white.svg"
