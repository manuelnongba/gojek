      ...
      <div>
        ...
        <section className="driver-two merchant-two">
          ...
          <div className="merchant-card merchant-food">
            <div>
              ...
              <p>
                Reach more potential customers and get easy delivery services
                with GoFood.
              </p>
            </div>
        ...
        <section className="driver-three">
          ...
          <div className="product-goride">
            ...
            <div>
              <h3 className="quote">
                "In the past, I had to send goods myself. Now GoBiz can help me
                in many ways."
              </h3>
          ...
          <div className="video-three">
            ...
            <div>
              <h3 className="quote">
                "My favorite (feature) is the open and close restaurant setting
                as our customers are able to k"
              </h3>
              <p>- Nita - Merchant partner</p>
            </div>
          </div>
        </section>
        <section className="product product-three driver-four merchant-four">
          <div className="three-heading">
            <h2>
              Interested to be<br></br> a Gojek merchant partner?
            </h2>
          </div>

          <div className="merchant-goride">
            <div>
              <h3>Food delivery</h3>
            </div>
            ...
            <div>
              <a href="http://gojek.com/goride">
                More Info <i class="pi pi-next align-middle"></i>
              </a>
            </div>
          </div>

          <div className="merchant-gocar">
            <div>
          ...
          <div className="transport-lo driver-man">
            <img
              alt=""
              src="https://lelogama.go-jek.com/prime/upload/image/link-sheet-spot-illustration.svg"
            />
          </div>
        </section>
      </div>
